  ...
  return (
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row md:justify-between">
      ...
      <div className="flex md:p-4 p-0 justify-center md:justify-normal">
        <select
          className="p2 m-3 bg-gray-900 text-white border-none outline-none text-sm lg:text-base"
        ...
        {user && (
          <>
            <button
              className="bg-purple-600 text-white text-sm rounded-md pl-3 pr-3 m-3 lg:text-base"
            ...
            <button
              className=" text-white font-bold rounded-md p-2 text-sm lg:text-base"
              onClick={handleSignOut}
            >
              {lang[chosenLang].signOutText}
            </button>
            <div className="relative inline-flex items-center justify-center lg:w-10 lg:h-10  md:w-8 md:h-8 overflow-hidden bg-red-600 rounded-full dark:bg-white-600 ml-3 mr-3 md:mt-2 md:inline-flex hidden">
              <span className="lg:font-medium md:text-sm text-white dark:text-white-300">
